...
namespace C969_Scheduling_Software___Richard_Jardine {
    ...
    public partial class client_scheduleDataSet : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public userRow AdduserRow(string userName, string password, sbyte active) {
...
namespace C969_Scheduling_Software___Richard_Jardine.client_scheduleDataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `user` SET `userName` = @p1, `password` = @p2, `active` = @p3 WHERE ((`use" +
                "rId` = @p4) AND (`userName` = @p5) AND (`password` = @p6) AND (`active` = @p7))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::C969_Scheduling_Software___Richard_Jardine.Properties.Settings.Default.client_scheduleConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `userId`, `userName`, `password`, `active` FROM `user`";
